...
<%
	...
	//한글이 깨지는 경우
	//- POST 전송할 때만 > ISO-8859-1 사용 > 다시 UTF-8 변환	
	//- GET > URL과 데이터를 같이 전송 > URL을 UTF-8로 처리(톰캣)

	
	//POST로 넘긴 데이터 인코딩 처리
	//- request.getParameter() 실행 전에
	request.setCharacterEncoding("UTF-8");

	//request.getParameter()
	//1. 입력하면 > 입력값 반환
	//2. 입력 안하면 > "" 반환
	//3. 컨트롤 X, 키 오타 > null 반환
	
	
	//텍스트 박스
	String txt1 = request.getParameter("txt1"); //Map
